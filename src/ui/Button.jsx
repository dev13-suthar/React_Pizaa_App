...
export default function Button({children,disabled,type,to,onClick}) {
  ...
  const styles = {
    ...
    secondary:'border-2 border-stone-300 uppercase font-semibold text-stone-400 inline-block tracking-wide rounded-full hover:bg-yellow-300 transition-colors duration-300 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-wait md:px-6 md:py-4',
